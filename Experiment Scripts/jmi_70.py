...
openml_datasets = [41158,41145,
4340,1565,40496,1512,40498,1540,375,1526,
275,277,377,1518,41972,1560,1468,40499]
#1015,1464,793,931,1021,40983,819,841,
#1004,1061,41966,834,995,40666,
#
#
...
for data in openml_datasets:
  ...
  for train_index, test_index in kfold.split(X):
    ...
    start = time()
    idx,_,_ = JMI.jmi(X[train_index], y[train_index], n_selected_features=num_fea7)
